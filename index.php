...
<div class="container guide-container">
	...
	<!--
	What goes in the preface?
	
	Explain what I am and am not covering:
		- I'm basically assuming you've played the game once or twice recently.  I'm not holding your hand through dungeons, but I'll point out which chests to pick up.
		- Not giving basic turn-by-turn directions or overworld/dungeon routing, watch a video for that
		- Will point out minor movement optimizations (fairy water usage) that are hard to pick up on
		- Information in tooltips will not necessarily be repeated every time it becomes relevant.
	
	General Guide Tense/Writing dealies to remember:
		- Second-person simple present: "(You) do this thing.  It's a good idea to do this other thing."
		- Make sure the bullet points are complete sentences.
		- Avoid abbreviating or shortening names of spells, items, locations, etc, and always capitalize them.
		- The Hero is "The Hero".  Avoid gendered pronouns but I think I've used masculine pronouns for him?
		- Make sure the bullets, details, and tooltips are generally used how I explained them in the preface.
	-->
	<div class="row">
		<div class="col-sm-12">
			<h3>Welcome</h3>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="commentary">
				If you've used this guide to learn the route, I'd love to hear what you thought of it.  Specifically, whether or not you thought the finished product actually fit the description of intent given above.  If you have any questions or feedback, you can contact me at TheCowness#1337 on Discord, or TheCowness on Twitter or Twitch.
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="step col-sm-12">Create a your file in Adventure Log 1 using a short name, male hero, and Message Speed 1.</div>
	</div>
	<div class="detail-container">
	<div class="row">
		<div class="col-sm-12">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
			Dragon Warrior IV uses "Game Start to Last Input" timing, so we don't run the timer while creating our character.  Start your timer as you press A to either select your message speed, or to load an existing <a href="#" data-toggle="tooltip" title="Meaning, a file that starts with the king talking to Ragnar.  Obviously, you cannot tamper with the savefile or start from a file that saved at the church in Burland.">new game file</a>.  Note that while creating a new file each time is both better practice <a href="#" data-toggle="tooltip" title="Due to how long it takes to unload all of the menus that open up during file creation, it's actually half a second faster to start timing off of Continue a Quest versus the Message Speed screen.">and <i>technically</i> affects timing</a>, no ruling has been made against using an existing new game file, so assuming you don't make any safety saves, you don't have to re-create your file every time you reset in Chapter One.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<br>
			Even though we will deathwarp later, we equip the wooden hat to avoid as many of the the <a href="#" data-toggle="tooltip" title="When Ragnar takes damage, you lose about one second to the screen shaking.  With the Wooden Hat, you will have more defense power than the attack power of the enemies around Burland, so you will only take (one point of) damage about 1/3 of the time you're attacked.">screen-shake damage animations</a> as possible.  An alternative power-strat is to unequip all of your armor during this walk so that the damage you take contributes to quickening the upcoming deathwarp, but you're very likely to die and reset.  I do not recommend this unless you're already willing to reset over <a href="#" data-toggle="tooltip" title="I generally reach Izmit for the first time between 2:30 and 3:30, so I tend to reset if I'm on the worse end of that range.  I've missed a WR by under a minute before, so I'd rather not lose a minute to RNG this early on.">encounter/run failure RNG</a> in the first chapter.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
			The item shop is on your immediate left upon entering town.  Herbs are the first item in the list, so you'll <a href="#" data-toggle="tooltip" title="This is something to keep in mind throughout the entire game.  You can always hold A while text is scrolling, but you'll have to mash when a Yes/No prompt pops up.">mash A through the prompts and hold A through the text messages</a>.<br>
			<br>
			...
			<table class="table table-responsive">
				...
				<tbody>
					<tr>
						...
						<td>14</td>
						<td>18</td>
						<td><a href="#" data-toggle="tooltip" title="Unsure of the probability; Icebolt is one of Ozwarg's six action slots, but casts way more often than 1/6 of the time.">Casts Icebolt once</a>, can fail to cast it once more.</td>
					</tr>
					<tr>
						<td>Giant Bantam</td>
						<td>24</td>
					...
					<tr>
						...
						<td>15</td>
						<td>16</td>
						<td><a href="#" data-toggle="tooltip" title="Unsure of the probability; SpeedUp is one of Pixie's six action slots, but it seems to cast more often than that.">Casts SpeedUp once</a>, does NOT fail to cast it once more.</td>
					</tr>
					<tr>
						<td>Lilypa</td>
						<td>16</td>
						...
						<td>20</td>
						<td>13</td>
						<td><a href="#" data-toggle="tooltip" title="Unsure of the probability; Upper is two of Lilypa's six action slots, but it seems to cast more often than that.">Casts Upper once</a>, does NOT fail to cast it once more.</td>
					</tr>
					<tr>
						<td>Ducksbill</td>
						<td>17</td>
						...
						<td>12</td>
						<td>14</td>
						<td><a href="#" data-toggle="tooltip" title="Unsure of the probability; Sap is one of Ducksbill's six action slots, but casts way more often than 1/6 of the time.">Casts Sap once</a>, can fail to cast it once more.</td>
					</tr>
					<tr>
						<td>Healer</td>
						<td>12</td>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="todo">
				TODO: How does the game round minimum HP?<br>
			...
			<table class="table table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td>32</td>
						<td>20</td>
						<td>Change Expression,<br>Attack,<br>On Guard</td>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				This fight is complicated, but since you're a Dragon Quest soldier, your party is very straightforward.  High-level overview:  You're going to <a href="#" data-toggle="tooltip" title="I've toyed with killing the Shadow first to make the enraged eyeball safer, but eyeball first is definitely faster and safer overall.">attack the Giant Eyeball until it dies</a>, and then attack Saro's Shadow until <i>it</i> dies.  Since your agility is <a href="#" data-toggle="tooltip" title="Eyeball 20 agi > Healie 18 Agi > Shadow 16 Agi > Ragnar ~7 agi.  Ragnar CAN go first, but never count on it.">very low</a>, there's very little else you can do to influence the outcome of this fight, but I'll explain the mechanics you're dealing with anyway.<br>
				<br>
				First thing first, kill the Giant Eyeball by attacking it <a href="#" data-toggle="tooltip" title="hopefully">twice</a> with Ragnar.  The eyeball will enrage if it drops under 33% health (1-14), which causes it to heal to 30 HP and switch to a double <a href="#" data-toggle="tooltip" title="Unconfirmed, but I believe it drops to 3 attack power and picks up the Ogrebasher's 10x damage 100% crit ability (enemy crits deal half damage: 3 * 10 / 2 = 15), but the enraged eyeball can hit for 14 and I'm not sure the Ogrebasher's damage can vary...">crit-or-miss</a> attack pattern, but there's little you can do to avoid it.  Two full physical attacks from Ragnar at level six should kill the Giant Eyeball, but it can parry to take half damage, which almost always knocks it into its transformation range.  If that's not bad enough, the eyeball will occasionally "cheat" and take half damage <a href="#" data-toggle="tooltip" title="Think, the parry/fight glitch from DW3.  It's basically the same thing.  Healie can do something similar, but it's rare and works differently.  Healie decides at the start of the round and then again when he acts whether or not he's parrying, so sometimes at the start of the round he'll take full damage, and then parry on his turn and start taking half damage.">even though it attacked you</a>.  For bonus points, if he parries an excellent move from Ragnar on turn one, he should always enrage.  The eyeball's usual damage is seven, and his enraged crits hit for 14-15.<br>
				<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="commentary">
				If you die at the beginning of the fight, it's about 3-4 minute time loss depending on encounter luck.  You'll almost always be sub 25 minutes finishing the chapter if this boss doesn't kill you, but until your PB is sub 7 hours you should definitely allow yourself at least one death to this boss.
			</div>
		</div>
	</div>
	<div class="row">
			...
			<table class="table table-responsive">
				...
				<tbody>
					<tr>
						...
						<td>28</td>
						<td>50</td>
						<td>Heal* (1/6),<br>Attack (3/6),<br>SleepHit (2/6)</td>
						<td><a href="#" data-toggle="tooltip" title="Only the last monster killed drops an item; do not kill the Rabidhounds last.">Drops Lifeforce Nuts (100%)</a>,<br>AI: Will always cast heal on himself below 50% HP (1-19) or on the Rabidhounds below 1/3 HP (1-7), otherwise select a move randomly with Heal counting as a physical attack.</td>
					</tr>
					<tr>
						<td>Rabidhound (x2)</td>
						<td>23</td>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
			First thing's first:  For your first couple of runs, you may not want to bother grinding on metal slimes.  An alternate grind strat (see below) will give you <a href="#" data-toggle="tooltip" title="In addition to being more stable, the alternate grind isn't more than five minutes slower than an average metal slime grind.">more consistency</a> if you just want to complete a few runs.  However, those strats will require you to have the gold chest out of Birdsong Tower, so you'll want to grab that on the first visit if you're not killing metal slimes.<br>
			<br>
			...
			<table class="table table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td>80</td>
						<td>45</td>
						<td>Boomerang (3/6),<br>Attack (2/6), On Guard (1/6)</td>
					...
					<tr>
						...
						<td>62</td>
						<td>68</td>
						<td>Icebolt,<br>Firebal,<br>Attack,<br>On Guard,<br>Healmore</td>
						<td>100% chance to drop an herb</td>
					<tr>
					<tr>
						<td>Sampson</td>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<br>
			Hun is a pushover, but will hit you 2-4 times depending on your strength and agility.  Equip the Iron Claw if you haven't already, and attack him until he dies.  Use one herb after the fight regardless of how much damage you take.<br>
			<br>
			Roric is where your max HP comes into play.  Hopefully he'll die before you need to use an herb, but he's a bit faster than you, so you should assume he will go before you.  He should go down in five hits, but damage rolls and parrying can make it take more.  Since it's 1v1 combat, you want him to parry, but often he needs to parry twice for the free damage to allow you to avoid one of his attacks.<br>
			<br>
			You'll probably use two herbs after this fight, but if you dodged an attack and you're over 60 HP after the first one, you're good.<br>
			<br>
			There are two ways to fight Vivian.  The first strategy is to attack her until she dies.  Alternatively, you can parry once or twice so that she spends 8 MP before casting Healmore on turn three.  Either way, you take about the same amount of damage, but if she opens with Firebal, it'll be faster to parry once.  Her attacks aren't evenly weighted, but generally she'll favor casting spells over physical attacks or parrying.  Note that when she's low on MP, she can fail to cast each of her spells one time.<br>
			<br>
			After this fight, use herbs until you're within 15 HP of your max.<br>
			<br>
			Sampson is the fight where your attack power really matters.  His defense is so high that even 2 points of strength can shorten the fight by one round, which can let you conserve herbs for Linguar.  The main problem with Sampson is that he can <a href="#" data-toggle="tooltip" title="I'm not sure how much this heals him for, but if it happens and you don't get a critical hit, you're dead.">heal himself</a> if he's under 50% HP, so before you've dealt over 45 points of damage, heal yourself to full and focus on attacking.  Usually he'll take 6-8 hits to kill, and your average damage will be somewhere in the 13-15 range (6-8 hits).<br>
			<br>
			If you have any herbs left, use two.  Then, the last fight begins...<br>
			<br>
			Linguar is pure RNG.  When the fight begins and after every turn of the fight, he creates three illusions and hides among them.  There's no way to manipulate him, and he has an even 25% chance of landing in each slot.  It's always faster to attack A, so the only reason to attack a different target is if he builds up power.  After he builds up power, if he moves to a different slot, he loses the built up power, so you get to make a decision:  Do you want to trade with him, or is your HP low enough that you can't have him hit you for double damage?  Essentially, if you're above 40 HP (including unused herbs), attack the one that built up power.  Otherwise, attack any of the others.  If your attack power is high (84+), you might kill him in two hits, but most of the time, it takes three.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<br>
			Walk all of the way out of Endor, to the world map.  <a href="#" data-toggle="tooltip" title="It's a few frames faster to give them to Brey instead, but this could cause problems against Necrosaro.">Use or drop</a> all of Alena's herbs along the way.  Cast Return to Santeem, and walk to the throne room.  After Brey says his line in the throne room, take one step or just stand still until your sprites animate once, and then cast Return to Santeem.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		...
		Sell: Hero Broad Sword, Hero Half Plate, Hero Staff of Punishment, Nara Morning Star, Taloon Iron Apron, Pink Leotard<br>
		Buy: Hero Sword of Lethargy<br>
		Circle around to the south counter to access the armor shop.<br>
		Buy: Cristo Sacred Robe, Hero Dragon Mail</div>
	</div>
	<div class="detail-container">
	<div class="row">
		<div class="col-sm-12">
			...
			<br>
			The Sword of Lethargy is a large part of what makes this route work.  If you attack an enemy with it, it'll have a 1/3 chance to put the enemy to sleep, including bosses who are immune to the Sleep spell.  When you use it in battle, it will cast Sleepmore, but this effect goes through the usual Sleep resistance, so it's not any more useful than casting the actual spell.  The Dragon Mail gives the Hero a 1/3 resistance to breath attacks, which is nice to have for a couple of dungeons later.  The Sacred Robe give Cristo a 1/3 resistance to spell damage, which is good to have for most of the remaining bosses in this chapter.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
			Equip Hero with Sword of Lethargy and Dragon Mail.  Equip Cristo with Sword of Miracles and Sacred Robe.
			</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<br>
			Alena will attack at the start of the fight, but after Keeleon takes a little damage she'll switch to using the Staff of Punishment, which will do more damage.  If she falls to low HP, she'll start defending every turn, so you'll need to heal her as soon as Keeleon goes to sleep.<br>
			<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				Before this fight, make sure Cristo is in your party and has the second Sword of Miracles equipped.  Start by putting your tactic on Defensive and casting Expel on the Demighouls.  Between Defeat's 40% chance to hit and Expel's 80% chance, this should clean up all three of them.  If it doesn't, depending on your team's health you can either cast Expel again, or start healing your team.<br>
				<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				Before entering the castle, go to Rosaville and sell Ragnar's Sword of Miracles to buy him a Sword of Lethargy, and equip it.  You should have some junk equipment still if you can't quite afford it.  Throw the Aeolus Shield into the wagon and make sure the Hero has the Sword of Decimation, Leaf of the World Tree, and Dew of the World Tree.  Your party order should be Ragnar, Alena, Hero, and Cristo.  Make sure one of them has the Baron's Horn.  Heal and save either in <a href="#" data-toggle="tooltip" title="I'm not sure which is faster, but I don't think Rosaville is faster than either if you save after using the inn, since the old man may not be at the appropriate counter."></a>Soretta or the Last Refuge</a>.<br>
				<br>
				Walk to Necrosaro.  If you get caught by the Clay Dolls, you can either attack them and hope they go to sleep, or use the Sword of Lethargy as an item to put them down.  They can cast Defeat, so be ready to reset if they kill off Cristo or too many other party members.  If you don't have the Hat of Happiness, you won't want to spend any of his MP on Vivify, and oddly these Clay Dolls are the biggest reason I would consider not cutting it.  The random encounters shouldn't be an issue in here as long as you keep your health high.<br>
				<br>
				Once you get through the castle, use the Baron's Horn, and then enter the mountain.  The final battle will begin when you step adjacent to Necrosaro, so stop one tile early and do the final preparations.  Double-check that the Hero's inventory matches the above, and that Hero and Ragnar both have Swords of Lethargy equipped.  Check your party's defense power and throw away Ragnar and Alena's helmets/shields so that you have <a href="#" data-toggle="tooltip" title="This is to get Cristo to cast Increase twice.  I need to do some testing personally on these numbers; I think EvilAsh usually says to have Ragnar under 90?  Phase one has 210 attack power -- is the secret number 105?">less than 100 defense power</a> on your two leading characters.<br>
				<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="commentary">
				I still need to do some real research on this fight, so don't assume these strats are optimized.  You'll want to practice the fight and play with it yourself to get a feel for how it goes.
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				Round one, change your tactics to Defensive and cast Fendspell on Necrosaro.  This will prompt Cristo to cast Increase instead of Defeat.  Starting turn two, attack with the Sword of Lethargy.  If Ragnar or Alena have too much defense power (if you didn't throw away enough armor, or if Alena simply has too much agility) Cristo will cast Upper instead of a second Increase.  If this happens, give up on the second Increase and move on.
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="todo">
				TODO: What if I anticipated this and swapped Alena for Lucia?  Does Lucia even have less than 100 defense power?  Does it even matter if I swap?  Ragnar and Alena benefit the most from the Increase casts, since Hero's a tank and Cristo sits in the back.<br>
				<br>
				TODO: Should Hero attack instead of lowering his defense power?  This could stop Alena from bumping him into the second phase too quickly.
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				Once your defense power is up, swap Cristo for Brey.  Once Necrosaro reaches a certain HP threshhold, Brey should start casting Bikill.  He'll usually cast it on Alena, then Ragnar, then Hero.  It's most important that it gets cast on Ragnar, since Bikill stops Alena from getting critical hits, but ideally Brey casts it on all three characters before Necrosaro goes into phase two.  If Necrosaro transforms before you're set up, you'll need to cast Fendspell on him again.<br>
				<br>
				...
				<table class="table-responsive">
					...
					<tr>
						<td>Round 2-3:</td>
						<td>Hero heal or attack (Zap?) Necrosaro, Cristo casts Increase (or Upper)</td>
					</tr>
					<tr>
						<td>Round 4:</td>
						<td>Swap Cristo for Brey, Hero heal or attack (Zap?) Necrosaro, Brey casts Bikill on Alena</td>
					</tr>
					<tr>
						<td>Round 5:</td>
						<td>Swap Alena for corpse to protect Brey, Brey casts Bikill on Ragnar</td>
					</tr>
					<tr>
						<td>Round 6:</td>
				...
				<br>
				The worst thing that can happen this early on in the fight is Brey getting slammed by a physical.  Depending on how many people he's Bikilled, you can decide whether or not to use your leaf on him.  Don't bother with Vivify; either pick him up or leave him behind.
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
			<div class="todo">
				...
				TODO: Why does Brey cast Bikill in that order?  Is it based on attack power, lowest to highest?  Can this information help at all?<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				After your setup is done, phases one and two are pretty free.  They don't hit too hard through Increase, and they've got relatively low HP.  Phase 3 is obnoxious, but does very low damage.  Remember that the Hero has the Awake spell in case Phase 3's Sweet Breath catches more than one of your team.<br>
				<br>
				Once his head falls off and you enter Phase 4, you need to start being careful.  Phase 4 attacks on a pattern and his rotation includes the Freezing Waves ability (despite Phase 4 not having fingertips).  Your options for avoiding Freezing Waves are:<br>
				...
				3) Just go for it and cast Ironize two turns after you see him meditate.<br>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="details">
				After Master Dragon is done talking to you, walk out of Zenithia castle.  Timing ends on last input, as soon as you start moving onto the tile that takes you out of the castle.  GG!
			</div>
		</div>
	</div>
	</div>
